...
final contractAddress ='0x065078e6e74a603e12e7e08c20ace2c9f897fae7db74163139fbe1ba4c07db61';
...
Future<String> regesteringUser(int amount) async {
  ...
  final res = await signerAccount.execute(
    functionCalls: [
      FunctionCall(
        contractAddress: Felt.fromHexString(contractAddress),
        entryPointSelector: getSelectorByName('relay_register'),
        calldata: [Felt.fromInt(amount),Felt.fromInt(0)],
      ),
    ],
    maxFee: defaultMaxFee,
  );
